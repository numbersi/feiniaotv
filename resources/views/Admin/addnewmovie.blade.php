            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal" id="myform" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="field-4">标识</label>
                            <div class="col-sm-10">
                                <input class="form-control"  type="text"  name="dytag"  id="field-5" placeholder="请输入视频标识"></input>
                            </div>
                        </div>
                        <div class="form-group-separator"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" name="dy_sort"  id="field-6" placeholder="请输入视频排序,数字越到越靠前">
                            </div>
                        </div>
                        <div class="form-group-separator"></div>
                        <div class="form-group">
