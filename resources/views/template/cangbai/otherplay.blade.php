	...
	<div class="stui-pannel-box">
		...
		<div class="stui-pannel_bd col-pd clearfix">
            ...
            @foreach($cxs['dy_addr'] as $v)
				<li>
					<a href="javascript:void(0)" id="bofang" class="am-btn am-btn-default lipbtn" data-href='{{config('playerconfig.m3u8').$v['url']}}' onclick="bofang(this)" target="_self">{{$v['name']}}</a>
				</li>
				@endforeach()
			</ul>
		</div>
